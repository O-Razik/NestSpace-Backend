...
{
    [Key] [Column("solo_event_id")] public Guid Id { get; set; }

    [Column("space_id")] public Guid SpaceId { get; set; }

    [Column("category_id")] public Guid CategoryId { get; set; }

    [Column("tittle")] [MaxLength(255)] public required string Title { get; set; }
    ...
    [Column("is_yearly")] public bool IsYearly { get; set; }

    [ForeignKey("CategoryId")] public EventCategory Category { get; set; } = null!;
